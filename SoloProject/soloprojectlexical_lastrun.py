...
expName = 'soloprojectlexical'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\kashy\\OneDrive\\Desktop\\SoloProject\\soloprojectlexical_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        text='In this task you will be asked to judge if a string of letters is a word or a non-word. \n\nPress the left arrow key for non-words and right arrow key for words. \nPlease respond as quickly as possible. \n\nPress SPACE to continue.',
        font='Arial',
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[fixation, text, key_resp, text_2],
        )
